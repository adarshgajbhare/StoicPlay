...
const LikedVideosPage = () => {
  ...
  const confirmDelete = async () => {
    try {
      await removeLikedVideo(user.uid, Array.from(videosToDelete));
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-6 py-12 px-4 max-w-xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-base leading-relaxed">
            You're missing out on awesome videos. Start exploring and hit that like button on your favorites!
          </p>
        </div>
      ) : (
